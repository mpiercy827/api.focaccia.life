defmodule ApiFocacciaLifeWeb.UserControllerTest do
  use ApiFocacciaLifeWeb.ConnCase

  alias ApiFocacciaLife.Focaccia
  alias ApiFocacciaLife.Focaccia.User

  @create_attrs %{email: "some email", name: "some name", session_token: "some session_token"}
  ...
  def fixture(:user) do
    {:ok, user} = Focaccia.create_user(@create_attrs)
    user
  end
